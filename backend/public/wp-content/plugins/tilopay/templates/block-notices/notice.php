...
<?php foreach ($notices as $notice) : ?>
	<div class="wc-block-components-notice-banner is-info wc-block-components-notices-tilopay" <?php echo wc_get_notice_data_attr($notice); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
															?> role="alert">
